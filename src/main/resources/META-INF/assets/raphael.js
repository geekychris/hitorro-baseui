...
(function (a) {
    var b = "0.3.2", c = "hasOwnProperty", d = /[\.\/]/, e = "*", f = function () {
        ...
        for (var s = 0, t = f.length; s < t; s++) {
            "zIndex" in f[s] && (o.push(f[s].zIndex), f[s].zIndex < 0 && (p[f[s].zIndex] = f[s]));
        }
        o.sort(g);
        while (o[l] < 0) {
    ...
    k.listeners = function (a) {
        ...
        for (var l = 0, m = f.length; l < m; l++) {
            for (var n = 0; n < k.length; n += i.length - 2) {
                i = [n, 1], g = k[n].n;
                if (f[l] != e) {
                    g[f[l]] && i.push(g[f[l]]);
                } else {
    ...
    function cr(b, d, e, f, h, i) {
        ...
        if (!!j) {
            if (!k) {
                for (attr in j) if (j[g](attr)) {
                    if (U[g](attr) || d.paper.customAttributes[g](attr)) {
                        ...
                        switch (U[attr]) {
                            ...
                            case"colour":
                                ...
                                break;
                            case"path":
                                var B = bG(u[attr], v[attr]), D = B[1];
                                u[attr] = B[0], w[attr] = [];
                                for (y = 0, z = u[attr].length; y < z; y++) {
                                    w[attr][y] = [0];
                                    for (var E = 1, F = u[attr][y].length; E < F; E++) {
                                        w[attr][y][E] = (D[y][E] - u[attr][y][E]) / t
                                    }
                                }
                                break;
                            case"transform":
                                var G = d._, H = bQ(G[attr], v[attr]);
                                if (H) {
                                    u[attr] = H.from, v[attr] = H.to, w[attr] = [], w[attr].real = !0;
                                    for (y = 0, z = u[attr].length; y < z; y++) {
                                        w[attr][y] = [u[attr][y][0]];
                                        for (E = 1, F = u[attr][y].length; E < F; E++) {
                                            w[attr][y][E] = (v[attr][y][E] - u[attr][y][E]) / t
                                        }
                                    }
                                } else {
                                ...
                                break;
                            case"csv":
                                var K = r(j[attr])[s](c), L = r(u[attr])[s](c);
                                if (attr == "clip-rect") {
                                    u[attr] = L, w[attr] = [], y = L.length;
                                    while (y--) {
                                        w[attr][y] = (K[y] - u[attr][y]) / t
                                    }
                                }
                                v[attr] = K;
                                break;
    ...
    var b, c = /[, ]+/, d = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1}, e = /\{(\d+)\}/g,
        ...
        T = a._availableAttrs = {
            ...
            x: C,
            y: C
        }, V = /\s*,\s*/, W = {hs: 1, rg: 1}, X = /,?([achlmqrstvxz]),?/gi,
        Y = /([achlmrqstvz])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?\s*,?\s*)+)/ig,
        Z = /([rstm])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?\s*,?\s*)+)/ig, $ = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)\s*,?\s*/ig,
        _ = a._radial_gradient = /^r(?:\(([^,]+?)\s*,\s*([^\)]+?)\))?/, ba = {}, bb = function (a, b) {
            return a.key - b.key
        }, bc = function (a, b) {
            return Q(a) - Q(b)
        }, bd = function () {
    ...
    a.color = function (b) {
        var c;
        a.is(b, "object") && "h" in b && "s" in b && "b" in b ? (c = a.hsb2rgb(b), b.r = c.r, b.g = c.g, b.b = c.b, b.hex = c.hex) : a.is(b, "object") && "h" in b && "s" in b && "l" in b ? (c = a.hsl2rgb(b), b.r = c.r, b.g = c.g, b.b = c.b, b.hex = c.hex) : (a.is(b, "string") && (b = a.getRGB(b)), a.is(b, "object") && "r" in b && "g" in b && "b" in b ? (c = a.rgb2hsl(b), b.h = c.h, b.s = c.s, b.l = c.l, c = a.rgb2hsb(b), b.v = c.b) : (b = {hex: "none"}, crl.r = b.g = b.b = b.h = b.s = b.v = b.l = -1)), b.toString = bp;
        return b
    ...
    var bx = bt(function (a) {
        ...
        var c = bA(a), d = b && bA(b), e = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null},
            f = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, g = function (a, b) {
                var c, d;
    ...
    var bT = function () {
        ...
        var b = a.clientX, c = a.clientY, d = h.doc.documentElement.scrollTop || h.doc.body.scrollTop,
            e = h.doc.documentElement.scrollLeft || h.doc.body.scrollLeft, f, g = bY.length;
        while (g--) {
            f = bY[g];
            if (o) {
        ...
        if (f) {
            ...
            for (var u = 0, v = k.length; u < v; u++) {
                ...
                l += u ? (w.w || f.w) + (w.k && w.k[k[u]] || 0) + f.w * i : 0, z && z.d && j.push(this.path(z.d).attr({
                    fill: "#000", stroke: "none", transform: [
                        ["t", l * n, 0]
                    ]
                }))
            }
    ...
    var q = function (d, e) {
        ...
        if (!s) {
            ...
            if (!w) return null;
            b.gradient && (p.defs.removeChild(b.gradient), delete b.gradient), k = k.replace(/[\(\)\s,\xb0#]/g, "-"), s = q(j + "Gradient", {id: k}), b.gradient = s, q(s, j == "radial" ? {
                fx: m,
                fy: n
            } : {x1: u[0], y1: u[1], x2: u[2], y2: u[3], gradientTransform: b.matrix.invert()}), p.defs.appendChild(s);
        ...
        if (d.type == "path") {
            var g = c(e).toLowerCase().split("-"), h = d.paper, i = f ? "end" : "start", j = d.node, k = d.attrs,
                l = k["stroke-width"], n = g.length, r = "classic", s, t, u, v, w, x = 3, y = 3, z = 5;
            while (n--) switch (g[n]) {
                case"block":
                case"classic":
                case"oval":
        ...
        for (var o in f) if (f[b](o)) {
            ...
            switch (o) {
                ...
                case"clip-rect":
                    ...
                    if (t.length == 4) {
                        ...
                        x.id = a.createUUID(), q(z, {
                            ...
                            width: t[2],
                            height: t[3]
                        }), x.appendChild(z), d.paper.defs.appendChild(x), q(i, {"clip-path": "url(#" + x.id + ")"}), d.clip = z
                    }
                    if (!p) {
                        var A = a._g.doc.getElementById(i.getAttribute("clip-path").replace(/(^url\(#|\)$)/g, l));
                        A && A.parentNode.removeChild(A), q(i, {"clip-path": l}), delete d.clip
                    }
                    break;
                case"path":
                    d.type == "path" && (q(i, {d: p ? k.path = a._pathToAbsolute(p) : "M0,0"}), d._.dirty = 1, d._.arrows && ("startString" in d._.arrows && w(d, d._.arrows.startString), "endString" in d._.arrows && w(d, d._.arrows.endString, 1)));
                    break;
                case"width":
                ...
                case"fill":
                    ...
                    if (C) {
                        ...
                        x.id = a.createUUID(), q(x, {
                            ...
                            height: 1,
                            width: 1
                        }), q(D, {x: 0, y: 0, "xlink:href": C[1]}), x.appendChild(D), function (b) {
                            a._preload(C[1], function () {
                                var a = this.offsetWidth, c = this.offsetHeight;
                                q(b, {width: a, height: c}), q(D, {width: a, height: c}), d.paper.safari()
                            })
                        }(x), d.paper.defs.appendChild(x), i.style.fill = "url(#" + x.id + ")", q(i, {fill: "url(#" + x.id + ")"}), d.pattern = x, d.pattern && v(d);
                        break
                    }
                    var E = a.getRGB(p);
                    if (!E.error) delete f.gradient, delete k.gradient, !a.is(k.opacity, "undefined") && a.is(f.opacity, "undefined") && q(i, {opacity: k.opacity}), !a.is(k["fill-opacity"], "undefined") && a.is(f["fill-opacity"], "undefined") && q(i, {"fill-opacity": k["fill-opacity"]}); else if ((d.type == "circle" || d.type == "ellipse" || c(p).charAt() != "r") && u(d, p)) {
                        if ("opacity" in k || "fill-opacity" in k) {
                            var F = a._g.doc.getElementById(i.getAttribute("fill").replace(/^url\(#|\)$/g, l));
                            if (F) {
                                var G = F.getElementsByTagName("stop");
                                q(G[G.length - 1], {"stop-opacity": ("opacity" in k ? k.opacity : 1) * ("fill-opacity" in k ? k["fill-opacity"] : 1)})
                            }
                        }
                        k.gradient = p, k.fill = "none";
                        break
                    }
                    E[b]("opacity") && q(i, {"fill-opacity": E.opacity > 1 ? E.opacity / 100 : E.opacity});
                case"stroke":
                    E = a.getRGB(p), i.setAttribute(o, E.hex), o == "stroke" && E[b]("opacity") && q(i, {"stroke-opacity": E.opacity > 1 ? E.opacity / 100 : E.opacity}), o == "stroke" && d._.arrows && ("startString" in d._.arrows && w(d, d._.arrows.startString), "endString" in d._.arrows && w(d, d._.arrows.endString, 1));
                    break;
                case"gradient":
                ...
                case"fill-opacity":
                    if (k.gradient) {
                        F = a._g.doc.getElementById(i.getAttribute("fill").replace(/^url\(#|\)$/g, l)), F && (G = F.getElementsByTagName("stop"), q(G[G.length - 1], {"stop-opacity": p}));
                        break
                    }
                    ;
                default:
        ...
        if (d.type == "text" && !!(f[b]("text") || f[b]("font") || f[b]("font-size") || f[b]("x") || f[b]("y"))) {
            ...
            if (f[b]("text")) {
                ...
                for (n = 0, o = k.length; n < o; n++) n ? q(k[n], {dy: i * A, x: g.x}) : q(k[0], {dy: 0})
            }
    ...
    C.prototype = D, D.constructor = C, a._engine.path = function (a, b) {
        ...
        var d = new C(c, b);
        d.type = "path", z(d, {fill: "none", stroke: "#000", path: a});
        return d
        ...
        a._extractTransform(this, c), this.clip && q(this.clip, {transform: this.matrix.invert()}), this.pattern && v(this), this.node && q(this.node, {transform: this.matrix});
        if (d.sx != 1 || d.sy != 1) {
    ...
    Element.prototype = A, A.constructor = Element, A.transform = function (b) {
        ...
        var d = new Element(c, b), e = {fill: "none", stroke: "#000"};
        ...
        e.X = b - d, e.Y = c - d, e.W = e.H = d * 2, e.type = "circle", setFillAndStroke(e, {cx: b, cy: c, r: d});
        return e
        ...
        var k = new Element(h, b), l = {fill: "#000", stroke: "none", font: a._availableAttrs.font, text: g};
