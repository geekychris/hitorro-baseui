...
Raphael = (function () {
    ...
    if (R.svg) {
        ...
        var updatePosition = function (o) {
            var bbox = o.getBBox();
            $(o.pattern, {patternTransform: R.format("translateClassFilenameToCanonical({0},{1})", bbox.x, bbox.y)});
        };
                        ...
                        case "fill":
                            ...
                            if (!R.getRGB(value).error) {
                                ...
                                if ((({
                                    circle: 1,
                                    ellipse: 1
                                })[has](o.type) || (value + E).charAt() != "r") && addGradientFill(node, value, o.paper)) {
        ...
        var leading = 1.2,
            ...
            Element = function (node, svg) {
                ...
                this.transformations = []; // rotate, translateClassFilenameToCanonical, scale
                this._ = {
                    tx: 0,
                    ty: 0,
                    rt: {deg: 0, cx: 0, cy: 0},
                ...
                if (fill.on && params.fill) {
                    ...
                    if (isURL) {
                        ...
                        if (R.getRGB(params.fill).error && (res.type in {
                            circle: 1,
                            ellipse: 1
                        } || (params.fill + E).charAt() != "r") && addGradientFill(res, params.fill)) {
                            a.fill = "none";
        ...
        Element[proto].attr = function (name, value) {
            ...
            if (params) {
                ...
                if (params.gradient && (({
                    circle: 1,
                    ellipse: 1
                })[has](this.type) || (params.gradient + E).charAt() != "r")) {
            ...
            Element[proto][eventName] = function (fn) {
                if (R.is(fn, "function")) {
                    ...
                    this.events.push({
                        name: eventName,
                        f: fn,
                        unbind: addEvent(this.shape || this.node, eventName, fn, this)
                    });
                }
                return this;
            };
    ...
    var animationElements = {length: 0},
        animation = function () {
            var Now = +new Date;
            for (var l in animationElements) {
                if (l != "length" && animationElements[has](l)) {
    ...
    for (var method in Element[proto]) {
        if (Element[proto][has](method)) {
